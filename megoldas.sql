...
--
-- Gép: localhost
-- Létrehozás ideje: 2018. Jún 14. 11:32
...
-- Adatbázis: `szeleromu`
--
CREATE DATABASE IF NOT EXISTS `szeleromu` DEFAULT CHARACTER SET utf8 COLLATE utf8_hungarian_ci;
USE `szeleromu`;
...
CREATE TABLE `helyszin` (
  `id` int(11) NOT NULL,
  `nev` varchar(16) CHARACTER SET utf8mb4 DEFAULT NULL,
...
CREATE TABLE `megye` (
  `id` int(11) NOT NULL,
  `nev` varchar(22) CHARACTER SET utf8mb4 DEFAULT NULL,
  `regio` varchar(18) CHARACTER SET utf8mb4 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
--
ALTER TABLE `helyszin`
  ADD CONSTRAINT `megyeid` FOREIGN KEY (`megyeid`) REFERENCES `megye` (`id`);

--
-- Megkötések a táblához `torony`
--
ALTER TABLE `torony`
  ADD CONSTRAINT `helyszinid` FOREIGN KEY (`helyszinid`) REFERENCES `helyszin` (`id`);
COMMIT;
